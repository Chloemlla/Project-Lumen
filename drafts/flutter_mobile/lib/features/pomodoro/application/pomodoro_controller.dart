...
import 'package:project_eye_mobile/features/pomodoro/domain/repositories/pomodoro_repository.dart';
...
class PomodoroController extends StateNotifier<PomodoroRuntimeState> {
  ...
  Future<void> _finishBreak({
    ...
    final nextCycleIndex =
        source.phase == PomodoroPhase.longBreak ? 1 : source.cycleIndex + 1;
