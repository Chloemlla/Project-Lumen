...
- Generated at: `2026-07-16 13:53:15Z`
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:116:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService``
- `docs/vivo-adaptation/REVIEW.md:47:### `scheduleAtFixedRate` (8 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:49:- `docs/ANDROID_16_VIVO_ADAPTATION.md:29:### 3. scheduleAtFixedRate backlog behavior (targetSdk 36+)``
- `docs/vivo-adaptation/REVIEW.md:50:- `docs/ANDROID_16_VIVO_ADAPTATION.md:33:- No `ScheduledExecutorService.scheduleAtFixedRate` usage found.``
- `docs/vivo-adaptation/REVIEW.md:51:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:114:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService```
- `docs/vivo-adaptation/REVIEW.md:52:- `docs/vivo-adaptation/REVIEW.md:48:### `scheduleAtFixedRate` (8 hit lines, showing up to 8)``
...
- `docs/vivo-adaptation/REVIEW.md:50:- `docs/ANDROID_16_VIVO_ADAPTATION.md:33:- No `ScheduledExecutorService.scheduleAtFixedRate` usage found.``
- `docs/vivo-adaptation/REVIEW.md:51:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:114:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService```
- `docs/vivo-adaptation/REVIEW.md:54:- `docs/vivo-adaptation/REVIEW.md:51:- `docs/ANDROID_16_VIVO_ADAPTATION.md:33:- No `ScheduledExecutorService.scheduleAtFixedRate` usage found.```
- `docs/vivo-adaptation/REVIEW.md:55:- `docs/vivo-adaptation/REVIEW.md:52:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:114:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService````
- `docs/vivo-adaptation/REVIEW.md:58:### `ScheduledExecutorService` (7 hit lines, showing up to 8)`
...
- `docs/vivo-adaptation/REVIEW.md:68:### `elegantTextHeight` (7 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:70:- `docs/ANDROID_16_VIVO_ADAPTATION.md:37:### 4. elegantTextHeight deprecated``
- `docs/vivo-adaptation/REVIEW.md:71:- `docs/ANDROID_16_VIVO_ADAPTATION.md:42:- No `elegantTextHeight=false` dependency.``
- `docs/vivo-adaptation/REVIEW.md:72:- `docs/vivo-adaptation/REVIEW.md:69:### `elegantTextHeight` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:73:- `docs/vivo-adaptation/REVIEW.md:71:- `docs/ANDROID_16_VIVO_ADAPTATION.md:37:### 4. elegantTextHeight deprecated```
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:115:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
- `app/src/main/AndroidManifest.xml:46:android:enableOnBackInvokedCallback="true"`
- `docs/vivo-adaptation/REVIEW.md:78:### `enableOnBackInvokedCallback` (8 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:80:- `docs/ANDROID_16_VIVO_ADAPTATION.md:25:- Application sets `android:enableOnBackInvokedCallback="true"`.``
- `docs/vivo-adaptation/REVIEW.md:81:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:113:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed```
- `docs/vivo-adaptation/REVIEW.md:82:- `app/src/main/AndroidManifest.xml:46:android:enableOnBackInvokedCallback="true"``
- `docs/vivo-adaptation/REVIEW.md:83:- `docs/vivo-adaptation/REVIEW.md:79:### `enableOnBackInvokedCallback` (8 hit lines, showing up to 8)``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:101:用命中行快速跳到 Manifest、BackHandler、Alarm、Share Intent、网络配置等位置。`
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:115:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:115:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
- `docs/vivo-adaptation/REVIEW.md:81:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:113:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed```
- `docs/vivo-adaptation/REVIEW.md:85:- `docs/vivo-adaptation/REVIEW.md:82:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:113:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed````
- `docs/vivo-adaptation/REVIEW.md:91:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispatcher`), not `onBackPressed()`.``
- `docs/vivo-adaptation/REVIEW.md:95:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:113:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed```
- `docs/vivo-adaptation/REVIEW.md:100:### `onBackPressed` (8 hit lines, showing up to 8)`

### `OnBackPressed` (6 hit lines, showing up to 8)

- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispatcher`), not `onBackPressed()`.`
- `docs/vivo-adaptation/REVIEW.md:91:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispatcher`), not `onBackPressed()`.``
- `docs/vivo-adaptation/REVIEW.md:103:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispatcher`), not `onBackPressed()`.``
- `docs/vivo-adaptation/REVIEW.md:107:- `docs/vivo-adaptation/REVIEW.md:92:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispa`
- `docs/vivo-adaptation/REVIEW.md:111:### `OnBackPressed` (6 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:113:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispatcher`), not `onBackPressed()`.``
...
- `docs/vivo-adaptation/REVIEW.md:120:### `predictive` (8 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:122:- `docs/ANDROID_16_VIVO_ADAPTATION.md:112:- 2026-07-16: Re-fetched docs 797 + 832 together; reconfirmed predictive back, adaptive layout, intentMatchingFlags, a`
- `docs/vivo-adaptation/REVIEW.md:123:- `.trellis/tasks/07-16-vivo-doc-797-832-refresh/prd.md:9:- Confirmed Android 16 predictive back / adaptive layout / intent matching already present``
- `docs/vivo-adaptation/REVIEW.md:124:- `.trellis/tasks/07-16-vivo-doc-832-android16-refresh/prd.md:8:- Revalidated adaptive layout / predictive back / jobs / health / LAN / ART items``
- `docs/vivo-adaptation/REVIEW.md:125:- `docs/vivo-adaptation/REVIEW.md:121:### `predictive` (8 hit lines, showing up to 8)``

### `screenOrientation` (6 hit lines, showing up to 8)

- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:114:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation``
- `docs/vivo-adaptation/REVIEW.md:131:### `screenOrientation` (6 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:133:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation```
- `docs/vivo-adaptation/REVIEW.md:134:- `docs/vivo-adaptation/REVIEW.md:132:### `screenOrientation` (6 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:135:- `docs/vivo-adaptation/REVIEW.md:134:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
- `docs/vivo-adaptation/REVIEW.md:136:- `docs/vivo-adaptation/REVIEW.md:135:- `docs/vivo-adaptation/REVIEW.md:132:### `screenOrientation` (6 hit lines, showing up to 8)```
...
- `docs/vivo-adaptation/REVIEW.md:133:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation```
- `docs/vivo-adaptation/REVIEW.md:135:- `docs/vivo-adaptation/REVIEW.md:134:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
- `docs/vivo-adaptation/REVIEW.md:137:- `docs/vivo-adaptation/REVIEW.md:136:- `docs/vivo-adaptation/REVIEW.md:134:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:110:- 大屏：`screenOrientation`、`resizeableActi`
- `docs/vivo-adaptation/REVIEW.md:144:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation```
- `docs/vivo-adaptation/REVIEW.md:149:- `docs/vivo-adaptation/REVIEW.md:134:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
...
- `docs/vivo-adaptation/REVIEW.md:160:### `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` (7 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:162:- `docs/ANDROID_16_VIVO_ADAPTATION.md:19:- No `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` opt-out; we adapt instead of disabling.``
- `docs/vivo-adaptation/REVIEW.md:163:- `docs/ANDROID_17_VIVO_ADAPTATION.md:40:- No reliance on `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY`.``
- `docs/vivo-adaptation/REVIEW.md:164:- `docs/vivo-adaptation/REVIEW.md:161:### `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:165:- `docs/vivo-adaptation/REVIEW.md:163:- `docs/ANDROID_16_VIVO_ADAPTATION.md:19:- No `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` opt-out; we adapt instead of`
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:118:- 网络：`usesCleartextTraffic`、`networkSecurityConfig`、`ACCESS_LOCAL_NETWORK``
- `docs/vivo-adaptation/REVIEW.md:170:### `ACCESS_LOCAL_NETWORK` (10 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:172:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.``
- `docs/vivo-adaptation/REVIEW.md:173:- `docs/ANDROID_17_VIVO_ADAPTATION.md:52:`ACCESS_LOCAL_NETWORK` becomes required for LAN/mDNS access when targetSdk >= 37.``
...
- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.`
- `docs/vivo-adaptation/REVIEW.md:172:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.``
- `docs/vivo-adaptation/REVIEW.md:178:- `docs/vivo-adaptation/REVIEW.md:173:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future f`
- `docs/vivo-adaptation/REVIEW.md:181:### `NEARBY_WIFI_DEVICES` (7 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:183:- `docs/ANDROID_13_VIVO_ADAPTATION.md:60:- No Wi-Fi RTT/hotspot management that needs `NEARBY_WIFI_DEVICES`.``
- `docs/vivo-adaptation/REVIEW.md:184:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.``
...
- `docs/vivo-adaptation/REVIEW.md:191:### `BODY_SENSORS` (8 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:193:- `docs/ANDROID_13_VIVO_ADAPTATION.md:61:- No body-sensor / heart-rate APIs; no `BODY_SENSORS(_BACKGROUND)`.``
- `docs/vivo-adaptation/REVIEW.md:194:- `docs/ANDROID_16_VIVO_ADAPTATION.md:45:Heart-rate and related APIs move from `BODY_SENSORS` to `android.permission.health.*`.``
- `docs/vivo-adaptation/REVIEW.md:195:- `docs/ANDROID_16_VIVO_ADAPTATION.md:48:- App does not use heart-rate / BODY_SENSORS APIs.``
- `docs/vivo-adaptation/REVIEW.md:196:- `docs/vivo-adaptation/REVIEW.md:192:### `BODY_SENSORS` (8 hit lines, showing up to 8)``
...
- `app/src/main/res/xml/network_security_config.xml:4:- Prefer networkSecurityConfig over android:usesCleartextTraffic.`
- `docs/vivo-adaptation/REVIEW.md:176:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:116:- 网络：`usesCleartextTraffic`、`networkSecurityConfig`、`ACCESS_LOCAL_NETWORK```
- `docs/vivo-adaptation/REVIEW.md:204:- `docs/ANDROID_17_VIVO_ADAPTATION.md:43:`usesCleartextTraffic` is on a deprecation path; prefer `networkSecurityConfig`.``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:117:- 分享/URI：`ACTION_SEND`、`FLAG_GRANT_READ_URI_PERMISSION`、`FileProvider``
...
- `docs/vivo-adaptation/REVIEW.md:229:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:115:- 分享/URI：`ACTION_SEND`、`FLAG_GRANT_READ_URI_PERMISSION`、`FileProvider```
- `docs/vivo-adaptation/REVIEW.md:235:### `ACTION_SEND` (13 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:237:- `docs/ANDROID_17_VIVO_ADAPTATION.md:24:Do not rely on implicit URI grants for `ACTION_SEND` / `ACTION_SEND_MULTIPLE` / stream URIs.``

### `FileProvider` (58 hit lines, showing up to 8)

- `docs/ANDROID_11_VIVO_ADAPTATION.md:24:- Shared/exported files go through FileProvider cache paths + `SecureShareIntents` URI grants.`
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:119:- 音频/FGS：`mediaPlayback`、`USAGE_NOTIFICATION`、`FOREGROUND_SERVICE``
...
- `docs/vivo-adaptation/REVIEW.md:257:### `mediaPlayback` (10 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:259:- `docs/ANDROID_17_VIVO_ADAPTATION.md:14:Android 17 requires foreground-visible state or a `mediaPlayback` FGS with While-In-Use capability for sustained audio `
- `docs/vivo-adaptation/REVIEW.md:260:- `docs/ANDROID_17_VIVO_ADAPTATION.md:20:- Do not introduce continuous background media playback without a `mediaPlayback` FGS.``

### `FOREGROUND_SERVICE` (22 hit lines, showing up to 8)

- `docs/ANDROID_11_VIVO_ADAPTATION.md:52:- `ProximityDetectionService` declares `foregroundServiceType="camera"` and `FOREGROUND_SERVICE_CAMERA`.`
...
- `docs/vivo-adaptation/REVIEW.md:261:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:117:- 音频/FGS：`mediaPlayback`、`USAGE_NOTIFICATION`、`FOREGROUND_SERVICE```
- `docs/vivo-adaptation/REVIEW.md:272:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:117:- 音频/FGS：`mediaPlayback`、`USAGE_NOTIFICATION`、`FOREGROUND_SERVICE```
- `docs/vivo-adaptation/REVIEW.md:279:### `USAGE_NOTIFICATION` (9 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:281:- `docs/ANDROID_17_VIVO_ADAPTATION.md:18:- `AudioService` uses `AudioAttributes.USAGE_NOTIFICATION` / `CONTENT_TYPE_SONIFICATION`.``
...
- `docs/vivo-adaptation/REVIEW.md:290:### `HiddenApiBypass` (7 hit lines, showing up to 8)`
- `docs/vivo-adaptation/REVIEW.md:292:- `docs/ANDROID_16_VIVO_ADAPTATION.md:84:Avoid HiddenApiBypass and unsupported packers that rely on ART internals.``
- `docs/vivo-adaptation/REVIEW.md:293:- `docs/ANDROID_16_VIVO_ADAPTATION.md:87:- No HiddenApiBypass dependency.``
- `docs/vivo-adaptation/REVIEW.md:294:- `docs/vivo-adaptation/REVIEW.md:291:### `HiddenApiBypass` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:295:- `docs/vivo-adaptation/REVIEW.md:293:- `docs/ANDROID_16_VIVO_ADAPTATION.md:84:Avoid HiddenApiBypass and unsupported packers that rely on ART internals.```

### `targetSdk` (34 hit lines, showing up to 8)
...
### `compileSdk` (24 hit lines, showing up to 8)
