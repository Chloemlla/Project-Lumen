...
- Generated at: `2026-07-16 13:36:57Z`
- Repo root: `F:\Repositories\GitHub\Project-Lumen`
- Output dir: `F:\Repositories\GitHub\Project-Lumen\docs\vivo-adaptation`

## Documents

### 586 — vivo Android 13应用适配指南

- Page: https://dev.vivo.com.cn/documentCenter/doc/586
- API: `https://dev.vivo.com.cn/webapi/doc/info?id=586`
- Breadcrumbs: vivo系统适配指南,Android适配,Android 13 应用适配指南
- Version code: 7
- Update time (UTC): 2023-01-18T06:41:31+00:00
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:111:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService``
...
- `docs/vivo-adaptation/REVIEW.md:43:- `docs/vivo-adaptation/REVIEW.md:38:### `scheduleAtFixedRate` (8 hit lines, showing up to 8)``
...
- `docs/vivo-adaptation/REVIEW.md:41:- `docs/ANDROID_16_VIVO_ADAPTATION.md:33:- No `ScheduledExecutorService.scheduleAtFixedRate` usage found.``
- `docs/vivo-adaptation/REVIEW.md:42:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:109:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService```
- `docs/vivo-adaptation/REVIEW.md:45:- `docs/vivo-adaptation/REVIEW.md:41:- `docs/ANDROID_16_VIVO_ADAPTATION.md:33:- No `ScheduledExecutorService.scheduleAtFixedRate` usage found.```
- `docs/vivo-adaptation/REVIEW.md:46:- `docs/vivo-adaptation/REVIEW.md:42:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:109:- 定时：`scheduleAtFixedRate`、`ScheduledExecutorService````
...
- `docs/vivo-adaptation/REVIEW.md:63:- `docs/vivo-adaptation/REVIEW.md:59:### `elegantTextHeight` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:64:- `docs/vivo-adaptation/REVIEW.md:61:- `docs/ANDROID_16_VIVO_ADAPTATION.md:37:### 4. elegantTextHeight deprecated```
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:110:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
...
- `docs/vivo-adaptation/REVIEW.md:74:- `docs/vivo-adaptation/REVIEW.md:69:### `enableOnBackInvokedCallback` (8 hit lines, showing up to 8)``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:98:用命中行快速跳到 Manifest、BackHandler、Alarm、Share Intent、网络配置等位置。`
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:110:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:110:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed``
- `docs/vivo-adaptation/REVIEW.md:72:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:108:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed```
- `docs/vivo-adaptation/REVIEW.md:76:- `docs/vivo-adaptation/REVIEW.md:72:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:108:- 返回：`enableOnBackInvokedCallback`、`BackHandler`、`onBackPressed````
...
- `docs/vivo-adaptation/REVIEW.md:98:- `docs/vivo-adaptation/REVIEW.md:82:- `docs/ANDROID_16_VIVO_ADAPTATION.md:26:- Navigation interception uses Compose `BackHandler` (Activity `OnBackPressedDispa`
...
- `docs/vivo-adaptation/REVIEW.md:116:- `docs/vivo-adaptation/REVIEW.md:111:### `predictive` (8 hit lines, showing up to 8)``

### `screenOrientation` (6 hit lines, showing up to 8)

- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:109:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation``
...
- `docs/vivo-adaptation/REVIEW.md:125:- `docs/vivo-adaptation/REVIEW.md:122:### `screenOrientation` (6 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:126:- `docs/vivo-adaptation/REVIEW.md:124:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:107:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
- `docs/vivo-adaptation/REVIEW.md:127:- `docs/vivo-adaptation/REVIEW.md:125:- `docs/vivo-adaptation/REVIEW.md:167:### `screenOrientation` (6 hit lines, showing up to 8)```
...
- `docs/vivo-adaptation/REVIEW.md:124:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:107:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation```
- `docs/vivo-adaptation/REVIEW.md:126:- `docs/vivo-adaptation/REVIEW.md:124:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:107:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
- `docs/vivo-adaptation/REVIEW.md:128:- `docs/vivo-adaptation/REVIEW.md:126:- `docs/vivo-adaptation/REVIEW.md:169:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:107:- 大屏：`screenOrientation`、`resizeableActi`
...
- `docs/vivo-adaptation/REVIEW.md:140:- `docs/vivo-adaptation/REVIEW.md:124:- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:107:- 大屏：`screenOrientation`、`resizeableActivity`、`setRequestedOrientation````
...
- `docs/vivo-adaptation/REVIEW.md:155:- `docs/vivo-adaptation/REVIEW.md:151:### `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:156:- `docs/vivo-adaptation/REVIEW.md:153:- `docs/ANDROID_16_VIVO_ADAPTATION.md:19:- No `PROPERTY_COMPAT_ALLOW_RESTRICTED_RESIZABILITY` opt-out; we adapt instead of`
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:113:- 网络：`usesCleartextTraffic`、`networkSecurityConfig`、`ACCESS_LOCAL_NETWORK``
...
- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.`
- `docs/vivo-adaptation/REVIEW.md:163:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future feature needs LAN.``
- `docs/vivo-adaptation/REVIEW.md:169:- `docs/vivo-adaptation/REVIEW.md:163:- `docs/ANDROID_16_VIVO_ADAPTATION.md:56:- No `NEARBY_WIFI_DEVICES` / `ACCESS_LOCAL_NETWORK` declaration unless a future f`
...
- `docs/vivo-adaptation/REVIEW.md:185:- `docs/vivo-adaptation/REVIEW.md:181:### `BODY_SENSORS` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:186:- `docs/vivo-adaptation/REVIEW.md:183:- `docs/ANDROID_16_VIVO_ADAPTATION.md:45:Heart-rate and related APIs move from `BODY_SENSORS` to `android.permission.healt`
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:112:- 分享/URI：`ACTION_SEND`、`FLAG_GRANT_READ_URI_PERMISSION`、`FileProvider``
...
- `docs/VIVO_ADAPTATION_DOC_WORKFLOW.md:114:- 音频/FGS：`mediaPlayback`、`USAGE_NOTIFICATION`、`FOREGROUND_SERVICE``
...
- `docs/vivo-adaptation/REVIEW.md:283:- `docs/vivo-adaptation/REVIEW.md:279:### `HiddenApiBypass` (7 hit lines, showing up to 8)``
- `docs/vivo-adaptation/REVIEW.md:284:- `docs/vivo-adaptation/REVIEW.md:281:- `docs/ANDROID_16_VIVO_ADAPTATION.md:84:Avoid HiddenApiBypass and unsupported packers that rely on ART internals.```

### `targetSdk` (30 hit lines, showing up to 8)
...
- `docs/ANDROID_14_VIVO_ADAPTATION.md:65:- `targetSdk = 37`, far above the floor.`

### `compileSdk` (21 hit lines, showing up to 8)
