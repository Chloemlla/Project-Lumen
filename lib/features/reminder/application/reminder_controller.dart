...
final reminderControllerProvider =
    StateNotifierProvider<ReminderController, ReminderRuntimeState>((ref) {
...
class ReminderController extends StateNotifier<ReminderRuntimeState> {
  ...
  Future<void> _recoverOrEnterBreak({
    ...
    if (!resumeAt.isBefore(breakEndAt)) {
      await _repository.addRestDuration(
  ...
  Future<void> _enterResting({
    ...
    await _notificationService.cancelReminderNotifications();
    await _notificationService.scheduleBreakFinished(scheduledAt: breakEndAt);
  ...
  Future<void> _beginWorkingCycle({
    ...
    await _notificationService.scheduleReminderDue(scheduledAt: nextReminderAt);
